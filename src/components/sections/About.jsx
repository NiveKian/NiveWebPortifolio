      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
          <p className="text-gray-300 text-center mb-6">
            Me chamo Ian S. Antunes, sou bacharel em Ciências da Computação pela
            Universidade Estadual da Bahia (UESB). Possuo experiência na área de
            desenvolvimento Backend, principalmente em TypeScript, e também na
            criação de modelos de classificação usando TensorFlow. Atualmente,
            estou buscando trabalho na área como também uma especialização.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                ...
                <li>
                    Diciplinas Relevantes: Estruturas de dados, Desenvolvimento Web, Grafos...
                </li>
              </ul>
            </div>
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
